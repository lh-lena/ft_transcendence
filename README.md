...
|------|-------------|---------|---------|
| **Frontend Developer** | TBD | Core Pong (25pts) + Tailwind UI (5pts) + Game Customization (5pts) | 35 |
| **Backend Developer** | TBD | Fastify Framework (10pts) + SQLite Database (5pts) + Live Chat (10pts) | 25 |
| **Realtime/AI Developer** | TBD | Remote Players (10pts) + AI Opponent (10pts) + Server-Side Pong (10pts) | 30 |
| **Security/Auth Developer** | TBD | User Management (10pts) + Google OAuth (10pts) + 2FA & JWT (10pts) | 30 |
| **DevOps Engineer** | TBD | Docker Setup + HTTPS/WSS + Monitoring with Prometheus/Grafana (5pts) | 5+ |
