...
export class SettingsPage {
    ...
    constructor(private router: Router) {
        ...
        this.main.className = 'w-full min-h-screen flex items-center justify-center bg-brandBlue';
    ...
    private toggleButton(button: HTMLElement, settingsList :Array<{ label: string; value: string }>): void {
      ...
      this.settingsPanel.parentNode?.replaceChild(newSettingsPanel, this.settingsPanel);
      this.settingsPanel = newSettingsPanel;
      this.populateSettingsPanel(settingsList)
    }

    private populateSettingsPanel(settingsList :Array<{ label: string; value: string }>): void {
